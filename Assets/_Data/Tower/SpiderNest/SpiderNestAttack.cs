...
public class SpiderNestAttack : TowerAttack
{
    ...
    [Range(0, 1)]
    [SerializeField] protected float attackTimeMultiplier = 0.4f;
    ...
    private void SetSpiderBotReady()
    {
        ...
        {
            activeSpider[i] =
                ProjectileSpawner.Instance.Spawn(spiderBotName, visual.AttachPoint[i].position + offset, Quaternion.identity);
